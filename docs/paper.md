...
AUC 0.95 and TSS 0.73, and its average matches the 8 percent daily flare rate. That is
...
by mistake for a while. The daily score is the strongest single region on the disk, not
a noisy-OR across all of them, for the reasons in Step 15 of EXPLAINED.md.
